...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  variant?: 'primary' | 'secondary' | 'ghost' | 'play' | 'download'
  size?: 'sm' | 'md' | 'lg'
  isLoading?: boolean
}
  ...
  ({
    ...
    const variants = {
      ...
      download: `
        ...
        text-white font-semibold
        shadow-[0_8px_16px_rgba(34,197,94,0.4),0_3px_6px_rgba(0,0,0,0.3),inset_0_1px_0_rgba(255,255,255,0.3)]
        hover:shadow-[0_12px_24px_rgba(34,197,94,0.5),0_6px_12px_rgba(0,0,0,0.4),inset_0_1px_0_rgba(255,255,255,0.4)]
        hover:scale-105
        active:scale-95
        active:shadow-[0_4px_8px_rgba(34,197,94,0.3),0_2px_4px_rgba(0,0,0,0.2),inset_0_-1px_0_rgba(0,0,0,0.2)]
        border-t border-white/20
        relative
        overflow-hidden
        before:absolute before:inset-0 before:bg-gradient-to-b before:from-white/20 before:to-transparent before:pointer-events-none
